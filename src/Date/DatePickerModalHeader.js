...
export default function DatePickerModalHeader(props) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Animated.View, { style: styles.animated },
            React.createElement(SafeAreaView, { style: [
                    styles.safeContent,
                    disableSafeTop && styles.safeContentNoTop,
                ] },
                React.createElement(Appbar, { style: styles.appbarHeader },
                    React.createElement(Appbar.Action, { icon: "close", accessibilityLabel: getTranslation(locale, 'close'), onPress: props.onDismiss, color: color, testID: "react-native-paper-dates-close" }),
                    React.createElement(Appbar.Content, { title: '' }),
                    React.createElement(Button, { color: color, onPress: props.onSave, uppercase: props.uppercase ?? true, testID: "react-native-paper-dates-save" }, saveLabel))))));
}
