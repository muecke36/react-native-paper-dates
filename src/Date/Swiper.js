...
function Swiper({ scrollMode, renderItem, renderHeader, renderFooter, selectedYear, initialIndex, }) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        isHorizontal ? (React.createElement(View, { style: styles.flex1 }, renderItem({ index, onPrev, onNext }))) : (React.createElement(AutoSizer, null, ({ width, height }) => (React.createElement(VerticalScroller, { width: width, height: height, initialIndex: initialIndex, estimatedHeight: estimatedMonthHeight, renderItem: renderItem })))),
        renderFooter && renderFooter(renderProps)));
}
const visibleArray = (i) => [i - 2, i - 1, i, i + 1, i + 2];
function VerticalScroller({ width, height, initialIndex, estimatedHeight, renderItem, }) {
    ...
    return (React.createElement("div", { ref: parentRef, style: {
        ...
        React.createElement("div", { style: {
                ...
                position: 'relative',
            } }, [0, 1, 2, 3, 4].map((vi) => (React.createElement("div", { key: vi, style: {
