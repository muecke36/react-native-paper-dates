...
import { circleSize, clockTypes, getAngle, getHours, getHourTypeFromOffset, getMinutes, hourTypes, } from './timeUtils';
...
function AnalogClock({ hours, minutes, focused, is24Hour, onChange, }) {
    ...
    const onPointerMove = React.useCallback((e, final) => {
        ...
        if (focusedRef.current === clockTypes.hours) {
            ...
            console.log(`Hour type = ${previousHourType}`);
            console.log(`Picked hours = ${pickedHours}`);
            ...
            console.log(`Result = ${pickedHours}`);
    ...
    return (React.createElement(View, { ref: clockRef, ...panResponder.panHandlers, style: [
            styles.clock,
            {
        ...
        React.createElement(View, { style: [
            ...
            React.createElement(View, { style: [styles.endPoint, { backgroundColor: theme.colors.primary }] })),
        React.createElement(View, { style: [StyleSheet.absoluteFill, styles.center], pointerEvents: "none" },
            React.createElement(View, { style: [
                    styles.middlePoint,
                    {
                        backgroundColor: theme.colors.primary,
        ...
        React.createElement(AnimatedClockSwitcher, { focused: focused, hours: React.createElement(AnalogClockHours, { is24Hour: is24Hour, hours: hours }), minutes: React.createElement(AnalogClockMinutes, { minutes: minutes }) })));
}
